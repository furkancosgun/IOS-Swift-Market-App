...
$sqlsorgu = "SELECT Product.Product_name,Category.category_name,Product.price,Product.img FROM `Product` 
INNER JOIN Category on Category.id = Product.category_id where Product.Product_name like '%$query%'";//Sorguy oluşturuldu
