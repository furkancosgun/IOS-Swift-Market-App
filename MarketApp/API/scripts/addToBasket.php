<?php
if(isset($_POST["productId"]) && isset($_POST["userId"]) && isset($_POST["piece"])){
...
$query = "Insert Into Basket (product_id,piece,user_id) values ('$productId','$piece','$userId')";
$isSuccess = mysqli_query($baglanti,$query);
if($isSuccess){
    $response["success"] = 4;//İşlem başarı degeri
    $response["message"] = "Added to Basket";
